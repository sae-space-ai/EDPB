export const AI_ACT_MAPPING: Record<string, { title: string; expertise: string[] }> = {
  ...
  "Art. 55": { title: "GPAI penalties", expertise: ["Regulatory Analysis"] },
  "Art. 56": { title: "Innovation support", expertise: ["AI Governance"] },
  "Art. 57": { title: "SME support", expertise: ["AI Compliance", "Fintech"] },
  "Art. 58": { title: "Sandboxes for SMEs", expertise: ["AI Governance"] },
  "Art. 59": { title: "Testing in real world", expertise: ["AI Risk Management"] },
  "Art. 60": { title: "Informed consent", expertise: ["Data Protection", "Human Oversight"] },
  "Art. 61": { title: "Supervision", expertise: ["AI Supervision", "Policy Monitoring"] },
  "Art. 62": { title: "Market surveillance", expertise: ["Regulatory Analysis"] },
